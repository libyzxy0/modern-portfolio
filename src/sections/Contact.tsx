  ...
  return (
    ...
    <section className="pb-5 w-full bg-gray-950" id="contact">
      <header className="mx-6 pt-6 md:mx-10">
        <h1 className="text-white font-bold text-3xl md:text-5xl">Contact<b className="text-transparent bg-clip-text bg-gradient-to-r from-sky-200 to-blue-400">.</b></h1>
      ...
      <div className="mx-6 md:mx-10 mt-5 flex flex-col md:flex-row md:flex-wrap mb-3">
        <a href="mailto:janlibydelacosta@gmail.com" className="flex flex-row text-sky-300 items-center mt-5 mr-5">
          <Icon className="h-16 w-16" icon="ic:baseline-email" />
          <div className="flex flex-col">
            <h1 className="text-white text-2xl font-bold mx-2">Send me email at:</h1>
            <p className="text-gray-400 mx-2">janlibydelacosta@gmail.com</p>
          </div>
        </a>
        <a href="https://facebook.com/libyzxy0" className="flex flex-row text-sky-300 items-center mt-5 mr-5">
        ...
        <a href="https://instagram.com/libyzxy0" className="flex flex-row text-sky-300 items-center mt-5 mr-3">
        ...
        <a href="https://linkedin.com/in/libyzxy0" className="flex flex-row text-sky-300 items-center mt-5 mr-3">
