  ...
  return (
    <section id="skills">
      <header className="mx-6 pt-6 md:mx-10">
        <h1 className="text-white font-bold text-3xl md:text-5xl">Skills<b className="text-transparent bg-clip-text bg-gradient-to-r from-sky-200 to-blue-400">.</b></h1>
        <div className="h-1 w-14 rounded-full bg-gradient-to-r from-sky-200 to-blue-400 md:w-20 md:h-2"></div>
        <p className="text-gray-400 font-[400] text-md mt-3">Technologies and tools i used.</p>
      </header>
        ...
        <TooltipProvider>
          <Tooltip>
           <TooltipTrigger>
             ...
             <Icon className="h-10 w-10 md:h-16 md:w-16" icon={skill.icon}  />
             </div>
           </TooltipTrigger>
